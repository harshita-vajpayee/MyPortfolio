  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/_harshi.itaa?igsh=MTY3M2xsdXlqZzRhZA=="
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/harshita-vajpayee-607288218"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Thank You for visiting my Portfolio</p>
        <p className="footer--content">This is a ReactJs based project.</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
